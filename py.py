...
The conventional binary search way of testing of element existence, hence list has to be sorted first and hence not preserving the element ordering. bisect_left() returns the first occurrence of element to be found and has working similar to lower_bound() in C++ STL.
